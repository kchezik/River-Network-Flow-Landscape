...
lsn = importSSN(filepath = "~/Documents/Simon_Fraser_University/PhD_Research/Projects/Data/Original Data/LSN/Fraser/lsn.ssn",predpts = "preds", o.write = F) #Load the .lsn dataset into R.
...
PDO_DOY2.Torg = Torgegram(lsn, "PDO_DOY2") #2
PDO_Max.Torg = Torgegram(lsn, "PDO_Max") #1
PDO_Min.Torg = Torgegram(lsn, "PDO_Min") #2
Y_DOY2_SE.Torg = Torgegram(lsn, "Y_DOY2_SE") #1
Y_Max_SE.Torg = Torgegram(lsn, "Y_Max_SE") #3
Y_Min_SE.Torg = Torgegram(lsn, "Y_MIN_SE") #3
PDO_DOY2_SE.Torg = Torgegram(lsn, "PDO_DOY2_S") #1
PDO_Max_SE.Torg = Torgegram(lsn, "PDO_Max_SE") #3
PDO_Min_SE.Torg = Torgegram(lsn, "PDO_Min_SE") #3
plot(PDO_Min_SE.Torg)
